...
def Relations(G,listeNomsPersonnages, entity_positions):
                                    ...
                                    if entity1 in i:
                                        if entity2 not in dictionnaireRelations[first_element]:
                                            ...
                                            for group in listeNomsPersonnages:
                                                if entity2 in group:
                                                    add_edges_with_sentiment_relation(G, first_element, group[0], sentiment)
    return dictionnaireRelations
                                    

    
def add_edges_with_sentiment_relation(G, source, target, sentiment):
...
for book in books:
    ...
    dictionnaireRelations = Relations(G,listeNomsPersonnages,entity_positions)
